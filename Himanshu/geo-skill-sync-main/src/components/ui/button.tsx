  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-transparent hover:bg-accent/5 text-foreground",
        secondary: "bg-gradient-secondary text-primary-foreground hover:opacity-90",
        ghost: "hover:bg-accent/10 hover:text-accent-foreground",
        link: "text-primary-glow underline-offset-4 hover:underline",
        hero: "bg-gradient-hero text-primary-foreground hover:opacity-90 glow-primary text-base font-semibold",
        glass: "glass hover:bg-accent/10 text-foreground border-border",
      },
      size: {
